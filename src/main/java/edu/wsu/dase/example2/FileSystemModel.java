 ...
 *         implements TreeTableModel AbstractTreeTableModel already implements
 *         TreeTableModel. don't need to re implement
 *
 */
...
public class FileSystemModel extends AbstractTreeTableModel {
	...
	static protected String[] cNames = { "Name", "Size", "Type", "Modified", "Checked" };
